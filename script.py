...
parser.add_argument('-mT','--mainTag',metavar="mainTag",nargs="?",help="A main tag to filter default=java",default=None)
parser.add_argument('-eT','--extrasTags',metavar="extrasTags",nargs="*",help="Extras tags to filter",default=None)
parser.add_argument('-mA','--minimumAnswers',metavar="minimumAnswers",type=int,nargs="?",help="Number of minimumAnswers of each question",default=0)
